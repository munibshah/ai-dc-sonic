#!/bin/sh
# leaf2 overlay primitives via SONiC CLI: VLAN 1000, bridge IP
# 192.168.100.2/24, VTEP src 10.0.10.2, VNI 10100. See leaf1's
# overlay-setup.sh for the model rationale.
set -e
