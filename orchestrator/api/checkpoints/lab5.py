"""
Lab 5 — Super Spines (conceptual). Checkpoints.

Lab 5 is a conceptual lab. The learner reads the guide, runs a few
...
# Lab 5 doesn't reshape the fabric — same FRR state in and out.
...
def _check_submit_finale_ping_mesh_intact():
    """The 56-pair worker mesh still pings — Lab 5 didn't disturb anything.

    Conceptual lab regression guard. If this fails, something else broke
    the overlay between Lab 4 and Lab 5 (it can't be us — we don't touch
...
CHECKPOINTS: list[tuple[str, str, callable]] = [
    ...
    ("submit_finale_ping_mesh_intact", "56-pair worker mesh still healthy — Lab 5 didn't disturb fabric",  _check_submit_finale_ping_mesh_intact),
]
